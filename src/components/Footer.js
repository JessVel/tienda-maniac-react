...
const Footer = ()=>{
    return(
        <Container fluid style={{backgroundColor: "#d3d3d3"}} expand="lg">
            <Row>
            <Col style={{textTransform: "uppercase"}} md={3}>
            ...
            <Col style={{textTransform: "uppercase"}} md={4}>
                <h6><small>medios de pago</small></h6>
                <img style={{height: "30px"}} src={visa}></img>
                <img style={{height: "30px"}} src={mastercard}></img>
                <img style={{height: "30px"}} src={amex}></img>
                <img style={{height: "30px"}} src={mercadoPago}></img>
                <img style={{height: "30px"}} src={pagoFacil}></img>
                <h6><small>medios de pago</small></h6>
                <img style={{height: "30px"}} src={correoArgentino}></img>
            ...
            <Col style={{textTransform: "uppercase"}} md={2}>
